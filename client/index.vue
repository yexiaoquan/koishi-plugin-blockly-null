  ...
  <k-layout class="page-blockly">
    ...
    <div style="height: 100%; display: flex;flex-flow: column">
      ...
      <transition name="meta-ui-change">
        <div style="position: fixed;bottom: 0;top: 0;right: 0;width: 400px;background-color: #ffffff7a;z-index: 1000;backdrop-filter: blur(50px);box-shadow: 9px -7px 20px 0px black;background-size: 50px;" v-show="( workspaceType === 'meta') && (currentId!=null && !loading )|| init ">
